...
import example.wxx.com.recyclerviewanalisys.list.CategoryListAdapter;
import example.wxx.com.recyclerviewanalisys.list.ChannelListResult;
import okhttp3.Call;
...
//        加一层数据
//        final WrapRecyclerAdapter adapter = new WrapRecyclerAdapter(mListAdapter);

        mRecyclerView.setAdapter(mListAdapter);
        final View view = LayoutInflater.from(this).inflate(R.layout.list_header_footer, mRecyclerView, false);
        ...
        mListAdapter.setItemClickListener(new ItemClickListener() {
            ...
            public void onItemClick(int position) {
                Toast.makeText(HeaderFooterListActivity.this, mData.get(position).getName(), Toast.LENGTH_SHORT).show();
        ...
        mListAdapter.setItemLongClickListener(new ItemLongClickListener() {
            ...
            public boolean onItemLongClick(int position) {
                Toast.makeText(HeaderFooterListActivity.this, "长按" + mData.get(position).getName(), Toast.LENGTH_SHORT).show();
                mData.remove(position);
                mListAdapter.notifyDataSetChanged();
                return true;
            }
